...
export const metadata: Metadata = {
  ...
  description: 'The page you are looking for could not be found. Explore Sikkim\'s sacred monasteries instead.',
};
      ...
      <div className="relative text-center max-w-lg">
        ...
        <div className="relative mb-8">
          <div className="w-32 h-32 mx-auto bg-gradient-to-br from-orange-200 to-amber-200 dark:from-orange-800/50 dark:to-amber-800/50 rounded-full flex items-center justify-center shadow-lg">
            <Mountain className="h-16 w-16 text-orange-600 dark:text-orange-400" />
          </div>
          {/* Decorative dots */}
        ...
        {/* Error code */}
        <h1 className="text-8xl font-bold text-orange-600 dark:text-orange-500 mb-4 tracking-tight">
          404
        </h1>
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
          ...
          Like a monk seeking enlightenment, sometimes we must find our way back.
        </p>
        ...
        <div className="mt-12 pt-8 border-t border-orange-200/50 dark:border-gray-800">
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Or explore these sacred spaces:</p>
